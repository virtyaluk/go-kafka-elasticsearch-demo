...
func randomInts(minDigit, maxDigit int) (p []int) {
...
func intSliceToStringSlice(intSlice []int) (strSlice []string) {
...
func getRandomPhoneNumber() string {
	rndInt := randomInts(1, 10)
	str := strings.Join(intSliceToStringSlice(rndInt), "")

	return fmt.Sprintf("%s-%s-%s", str[:3], str[3:6], str[6:10])
}

func getRandomUnixTime() int64 {
...
// GetRandomUserInfo returns randomly generated person info.
func GetRandomUserInfo() User {
	return User{
